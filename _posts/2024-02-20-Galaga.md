...
layout: post
title: Galaga
description: A Galaga Game By Nicolas Diaz. Shoot the Enemies using the space bar and move using the arrow keys, have fun and don't let the space invaders touch you!
type: tangibles
...
<body>
  ...
  <script>
    ...
    const initialEnemySpeed = 9; // Initial enemy falling speed
    const respawnEnemySpeed = 15; // Faster falling speed when enemies respawn
    const shotDelay = 600; // milliseconds
